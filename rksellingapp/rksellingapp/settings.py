"""
Django settings for rksellingapp project.
...
SECRET_KEY = '*uy!nri8g3dmd^=daxp^17!xao+p5f)h8i4=42dwu78h%j9dn%'
...
ROOT_URLCONF = 'rksellingapp.urls'
...
WSGI_APPLICATION = 'rksellingapp.wsgi.application'
